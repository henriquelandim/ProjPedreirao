namespace ApiPedreirao.Models
{
    public class TokenConfigurations
    {
        ...
        //O destinatário pretendido do token. O aplicativo que recebe o token deve verificar 
        //se o valor de público-alvo está correto e rejeitar quaisquer tokens destinados a um público-alvo diferente.
