...
namespace ApiPedreirao.Controllers
{
    ...
    public class LoginController:Controller{
        ...
        readonly APContexto _contexto;
        //vamos criar um construtor para inicializar a classe
        public LoginController(APContexto contexto){
            _contexto = contexto;
        }
        ...
        
        {
            ...
            if (user !=null){       //se o usuario user for diferente de nulo ele prossegue com o login 
                ...
                new Claim("Nivel", user.TipoUsuario)
                    }
                );

                Identity.AddClaim(new Claim(ClaimTypes.Role, user.TipoUsuario)); /*Definir a autorizacao do usuario . Quando for cliente */
